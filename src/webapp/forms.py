...
class ConfigForm(FlaskForm):
    ...
    artist = StringField(label='Enter Favorite Artist (Full Artist Name)', validators=[DataRequired()])
    track = StringField(label='Enter Favorite Track (Full Track Name)', validators=[DataRequired()])
